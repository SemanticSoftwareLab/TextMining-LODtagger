 ...
 */
@CreoleResource(name = "MuNPEx English (EN) NP Chunker",
  comment = "Multi-lingual Noun Phrase Extractor (MuNPEx) -- English",
...
public class MuNPExENTransducer extends Transducer {
  ...
  /**
   * The grammarURL parameter provides the MuNPEx-EN main.jape file as a default
   * for this PR.
   * 
   * @param newGrammarURL
   */
  @CreoleParameter(
    ...
    suffixes = "jape",
    defaultValue = "resources/en-np_main.jape"
  )
  @Override
