 ...
 */
@CreoleResource(name = "MuNPEx French (FR) NP Chunker",
  comment = "Multi-lingual Noun Phrase Extractor (MuNPEx) -- French",
...
public class MuNPExFRTransducer extends Transducer {
  ...
  /**
   * The grammarURL parameter provides the MuNPEx-FR main.jape file as a default
   * for this PR.
   * 
   * @param newGrammarURL
   */
  @CreoleParameter(
    ...
    suffixes = "jape",
    defaultValue = "resources/fr-np_main.jape"
  )
  @Override
